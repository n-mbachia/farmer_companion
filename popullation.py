...
# determines plants stands in unit area
...
print("In this ", format(acres, ',.2f'), "acrage, the total popullation density is ", format(plant_popullation, ',.0f'), " plants.")
